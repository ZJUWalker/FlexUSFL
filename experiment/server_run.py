...
if __name__ == "__main__":
    ...
    set_seed(SEED)
    # =====================================================================
    log_dir = f"log/{server_args['model']}/" f"client_number_{server_args['num_clients']}/v2/server"
    logger = create_logger(
        log_file_name="training_steps.log",
        log_dir=log_dir,
    )
    ...
    split_point = get_model_layer_num(model_dir) // 5  # TODO
